...
function PGF.Dialog_LoadFromModel(dialog)
    ...
    PGF.Table_UpdateWithDefaults(model, PGF.C.MODEL_DEFAULT)
    ...
    dialog.Tankrole.Act:SetChecked(model.tankrole.act)
    dialog.Healrole.Act:SetChecked(model.healrole.act)
    dialog.Dpsrole.Act:SetChecked(model.dpsrole.act)
...
function PGF.Dialog_OnLoad()
    ...
    dialog:SetScript("OnUpdate", PGF.Dialog_OnUpdate)
    dialog.TimeSinceLastUpdate = 0
    ...
    PGF.Dialog_SetUpGenericField(dialog, "Tankrole")
    PGF.Dialog_SetUpGenericField(dialog, "Healrole")
    PGF.Dialog_SetUpGenericField(dialog, "Dpsrole")
...
function PGF.Dialog_OnUpdate(this, arg1)
  PremadeGroupsFilterDialog.TimeSinceLastUpdate = PremadeGroupsFilterDialog.TimeSinceLastUpdate + arg1
  if (PremadeGroupsFilterDialog.TimeSinceLastUpdate > 10 and PremadeGroupsFilterDialog.searching) then
    LFGListSearchPanel_DoSearch(LFGListFrame.SearchPanel)
		PremadeGroupsFilterDialog.TimeSinceLastUpdate = 0
	end
end
